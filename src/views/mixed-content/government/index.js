...
const Government = () => {
  return (
    <Container data-testid="mixed-content-government">
      ...
      <Typography variant="h6">Why analyze government websites?</Typography>
      <Typography paragraph={true}>
        Governmental websites are unfortunately the ones that contain the most
        percentage of <b>mixed content</b> resources, this makes them a great
        attack target because they are popular and there&apos;s a great flux of
        sensitive information in them to be sniffed.
      </Typography>
